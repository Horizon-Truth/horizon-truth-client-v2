...
import { Download, BookOpen, ShieldCheck } from "lucide-react";
        ...
        <PublicLayout>
            <section className="py-20 bg-primary/5 border-b">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary/10 border border-primary/20 mb-8">
                        <resource.icon size={16} className="text-primary" />
            ...
            <section className="py-24 bg-background">
                <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    >
                        <Button size="lg" className="px-8 py-7 rounded-2xl font-black text-xl hover:shadow-2xl transition-all gap-2 h-auto text-primary-foreground">
                        ...
                        <div className="lg:col-span-2 space-y-12">
                            ...
                            <div className="space-y-6">
                                ...
                                <p className="text-xl text-muted-foreground leading-relaxed font-medium">
                                    {resource.fullContent || "This comprehensive module is designed to provide you with a deep understanding of digital literacy. Whether you're a student, researcher, or concerned citizen, this guide offers actionable insights to protect yourself and your community from the harmful effects of misinformation."}
                                </p>
                            </div>
                        </div>
