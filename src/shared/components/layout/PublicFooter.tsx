...
export const PublicFooter = () => {
    ...
    return (
        <footer className="py-12 border-t mt-auto bg-background" role="contentinfo">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
                ...
                <div className="flex gap-6 text-muted-foreground" role="list" aria-label="Social media links">
                    <a href="https://horizontruth.org" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors" aria-label="Horizon Truth website"><ShieldCheck size={18} /></a>
                    <a href="https://twitter.com/horizontruth" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors" aria-label="Horizon Truth on Twitter"><Globe size={18} /></a>
                    <a href="https://github.com/horizon-truth" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors" aria-label="Horizon Truth on GitHub"><Github size={18} /></a>
                </div>
            </div>
        </footer>
    );
