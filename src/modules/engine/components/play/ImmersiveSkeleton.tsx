...
export const ScenarioSkeleton = () => (
    <div className="flex flex-col gap-6 p-8 bg-card/10 border border-white/5 rounded-3xl relative overflow-hidden">
        ...
        <div className="space-y-4 relative z-10">
            ...
            <div className="w-1/2 h-4 bg-white/5 rounded-full pt-2" />
        </div>
        <div className="mt-auto w-full h-12 bg-white/5 rounded-2xl" />
    </div>
);

export const ChatSkeleton = () => (
    <div className="space-y-4 p-4 h-[400px] overflow-hidden bg-[#0F1721] rounded-2xl border border-white/5">
        {[1, 2, 3, 4].map((i) => (
            <motion.div
                key={i}
                initial={{ opacity: 0.3 }}
                ...
                className={cn(
                    ...
                    i % 2 === 0 ? "bg-blue-600/20 ml-auto rounded-tr-none" : "bg-[#212D3B]/40 mr-auto rounded-tl-none"
                )}
            />
        ))}
    </div>
            ...
            <div key={i} className="flex gap-4 opacity-40">
                ...
                <div className="flex-1 space-y-3">
                    ...
                    <div className="flex justify-between w-3/4">
                        <div className="w-8 h-4 bg-white/5 rounded-full" />
                        <div className="w-8 h-4 bg-white/5 rounded-full" />
                        <div className="w-8 h-4 bg-white/5 rounded-full" />
                    </div>
                </div>
