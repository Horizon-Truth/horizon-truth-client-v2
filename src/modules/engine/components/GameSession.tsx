                ...
                <div className="px-6 space-y-8">
                    ...
                    <div className="flex flex-col items-center text-center gap-4">
                        <div className="relative group">
                            <div className="absolute -inset-1 bg-gradient-to-tr from-primary to-blue-500 rounded-full blur opacity-20 group-hover:opacity-100 transition duration-1000"></div>
                            <Avatar className="w-20 h-20 border-2 border-white relative z-10">
                                <AvatarImage src={user?.avatarUrl} />
                                <AvatarFallback className="bg-slate-100 text-xl font-black text-slate-900">{user?.fullName?.charAt(0)}</AvatarFallback>
                            </Avatar>
                    ...
                    <div className="space-y-8 pt-4 flex flex-col items-center">
                        <div className={cn(
                            ...
                            <AnimatePresence>
                                {trustPulse !== 'none' && (
                                    ...
                                    >
                                        <div className="bg-white/80 backdrop-blur-md p-2 rounded-full border border-slate-200 shadow-2xl">
                                            {trustPulse === 'increase' ?
                        ...
                        <div className="p-4 rounded-2xl bg-slate-100 border border-slate-200 flex items-center justify-between group hover:bg-slate-200/50 transition-colors">
                            <div className="flex items-center gap-3">
                                <div className="p-2 rounded-xl bg-amber-500/10 text-amber-600">
                                    <Zap size={18} />
                                </div>
                                <span className="text-xs font-black uppercase tracking-wider text-slate-600">Level</span>
                            </div>
                        ...
                        <div className="p-4 rounded-2xl bg-slate-100 border border-slate-200 flex items-center justify-between group hover:bg-slate-200/50 transition-colors">
                            <div className="flex items-center gap-3">
                                ...
                                <span className="text-xs font-black uppercase tracking-wider text-slate-600">Influence</span>
                            </div>
                        ...
                        <div className="p-4 rounded-2xl bg-slate-100 border border-slate-200 flex items-center justify-between group hover:bg-slate-200/50 transition-colors">
                            <div className="flex items-center gap-3">
                                ...
                                <span className="text-xs font-black uppercase tracking-wider text-slate-600">Accuracy</span>
                            </div>
                ...
                <div className="p-6 h-full flex flex-col">
                    ...
                    <div className="flex-1 space-y-4 overflow-y-auto pr-2 custom-scrollbar">
                        ...
                        <div className="pt-8 space-y-4 border-t border-slate-200">
                            <h4 className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]">Active Nodes</h4>
                            <div className="p-4 rounded-xl bg-primary/5 border border-primary/10 space-y-3">
                                <div className="flex justify-between text-[10px] font-bold uppercase">
                                    <span className="text-slate-900">Node Strength</span>
                    ...
                    <div className="mt-8 p-6 rounded-2xl bg-gradient-to-br from-indigo-500/10 to-purple-500/10 border border-slate-200">
        ...
        <div className="ml-auto flex items-center gap-2">
            ...
            >
                <svg className="absolute inset-0 -rotate-90" width="40" height="40" viewBox="0 0 40 40">
                    <circle cx="20" cy="20" r={radius} fill="none" stroke="rgba(0,0,0,0.05)" strokeWidth="3" />
                    <circle
                ...
                <span className={cn('relative text-[11px] font-black tabular-nums', isUrgent ? 'text-red-500 animate-pulse' : 'text-slate-900')}>
                    {timeLeft}
                </span>
            </motion.div>
